        ...
        <div className="row">
          <div className="col-sm-6 col-lg-3">
            <h3 style={{ color: "#1E88E5" }}>
              ...
              FACTS
              <br></br>
              <small style={{ color: "#1E88E5" }}>per 100gr</small>
          ...
          <div className="col-sm-6 col-lg-3">
            ...
            <div className="row">
              <label className="col-6">
                Proteins &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {defaultValue.Proteins}g{" "}
              </label>
              <div className="col-6">XX %</div>
            </div>
            <div className="row">
      ...
      <CardBody style={{ backgroundColor: " #f5f5f5" }}>
        <div className="row">
          ...
          <div className="col-md">
            ...
            <p style={{ fontSize: 15 }}>Aqui alergenos</p>
          </div>
        </div>
      </CardBody>
      <CardBody>
